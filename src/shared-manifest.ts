...
// lock も共有ディレクトリ上の untrusted input なので manifest と同じく上限を持たせる
export const SHARED_STORE_LOCK_MAX_BYTES = 4 * 1024;
...
// 別拡張の scanner 値も残すので、列挙ではなく書式だけを制限する
export const SHARED_SOURCE_SCANNER_PATTERN = /^[A-Za-z0-9._-]{1,64}$/;
